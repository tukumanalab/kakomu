 ...
 *
 * ひらがなモードで変わるのは **文言だけ**。書体・文字サイズ・行間は漢字モードと同じ。
 * 画面の構造・ボタンの位置・機能も変わらない。
 * 文字を大きくすると別の画面に見えてしまい、隣の子と同じ画面だと伝わらないため。
 */
...
/** 切り替えを使うかどうか。false にすると漢字だけになる */
export const READING_SWITCH_ENABLED = true;
